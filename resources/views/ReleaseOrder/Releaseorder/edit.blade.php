...
@endphp
    <div class="container">
        <div class="card  border border-primary">
            ...
            <div class="card-body">
                <form action="{{ route('ro.update', $details[0]->ro_no) }}" method="POST" @submit.prevent="submit()" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group input-group-sm mb-6">
                                    ...
                                    <input type="text" name="rono" value="{{ old('rono') }}" disabled
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group input-group-sm mb-6">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-sm"><small>Trucker</small></span>
                                    </div>
                                     <select :class="['form-control', allerros.trucker ? 'border border-danger' : '']" v-model="form.trucker" name="trucker">
                    ...
                    <div class="form-group">
                        ...
                        name="remarks" v-model="form.remarks"></textarea>
                    </div>
    ...
    <script>
        new Vue({
            ...
            data() {
                return {
                    form: {
                        rono: '{!! $details[0]->ro_no !!}',
                        dateInput: '{!! $details[0]->deliver_date !!}',
                        driver:  '{!! $details[0]->driver !!}',
                        truck: '',
                        trucker: '{!! $details[0]->truckno !!}-{!! $details[0]->plate !!}',
                        plate: '',
                        area: '{!! $details[0]->area !!}',
                        remarks: ('{{ str_replace("'","'",$details[0]->remarks) }}').replace("&lt;br&gt;","\n"),
            ...
            methods: {
                fetchData(){
                    var ro = '{{ Request::segment(2) }}';
                       axios.get('/release/items/'+ro)
                        .then(response => {
                             this.invoice_products = (response.data)
                ...
                submit() {
                    ...
                    var url1 = "{{ url('release/update') }}";
                    url1 = url1.replace('%3Aid',this.form.rono);

                    axios.post(url1, dataform).then(response => {
                    ...
                    url = url.replace('%3Aid',this.form.rono);
                        ...
                        window.location.href  = "{{ url('release/delivery') }}";
                        this.resetForm();
                        this.success = true;
                        this.allerros = [];
