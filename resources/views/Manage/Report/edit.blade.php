                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-6">
                                        ...
                                        <input type="text" name="header" value="{{ $data->header1 }}" placeholder="" class="header1 form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-6">
                                        ...
                                        <input type="text" name="subheader"value="{{ $data->header2 }}" placeholder="" class="header2 form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-6">
                                        ...
                                        <input type="text" name="itemheader"value="{{ $data->header3 }}" placeholder="" class="header3 form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-6">
                                        ...
                                        <input type="text" name="itemcode" value="{{ $data->itemcode }}"placeholder="" class="itemcode form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-6">
                                        ...
                                        <select class="form-control" id="section" name="section">
                                            <option value="00001" {{ ($data->type=='00001')?'selected="selected"':'' }}>1st Section</option>
                                            <option value="00002" {{ ($data->type=='00002')?'selected="selected"':'' }}>2nd Section</option>
                                        </select>
                                    </div>
                                </div>
